 ...
 * gloutonne par ajout : on débute par une liste vide et on ajoute les objets
...
public class GloutonAjoutSolver {
	...
	public static List<ObjetInterface> resoudre(SacADosInterface sacADos) throws Exception {
        ...
        */
		...
		On recupere tous les objets qui respectent les conditions de notre interface SacADosInterface
		 grâce à notre getObjets. On crée une nouvelle liste avec ces objets.
		*/

        List<ObjetInterface> tousLesObjets = new ArrayList<>(sacADos.getObjets());

		/*
         Je définis comparatorByInterest comme le comparateur issus de ma
         classe TriParUtiliteSurSommeDesCouts
        */
