...
public class Evaluateur extends Personne {
	...
	public void evaluerCoutProjet(Projet projet) {
		...
		case ECONOMIQUE:
			...
			projet.setCoutEco(1000 + random.nextInt(10001)); 
			break;

		case SOCIAL:
			// Pour avoir un coût social entre 1000 et 10000
			projet.setCoutSocio(100 + random.nextInt(901));
			break;

		case ENVIRONNEMENT:
			// pour avoir un coût environnemental entre 1000 et 10000
			projet.setCoutEnv(50 + random.nextInt(451));
			break;
